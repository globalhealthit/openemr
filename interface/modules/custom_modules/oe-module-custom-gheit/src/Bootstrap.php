...
class Bootstrap
{
    ...
    const MODULE_NAME = "oe-module-custom-gheit";
    /**
    ...
    public function addGlobalSettingsSection(GlobalsInitializedEvent $event)
    {
        ...
        $section = xlt("Gheit Custom Module");
    ...
    public function addCustomModuleMenuItem(MenuEvent $event)
    {
        ...
        $menuItem->label = xlt("Custom Module Gheit");
        ...
        $menuItem->url = "/interface/modules/custom_modules/oe-module-custom-gheit/public/sample-index.php";
        $menuItem->children = [];
