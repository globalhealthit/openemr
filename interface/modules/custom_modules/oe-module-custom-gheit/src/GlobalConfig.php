...
class GlobalConfig
{
    const CONFIG_OPTION_TEXT = 'oe_gheit_config_option_text';
    const CONFIG_OPTION_ENCRYPTED = 'oe_gheit_config_option_encrypted';
    const CONFIG_OVERRIDE_TEMPLATES = "oe_gheit_override_twig_templates";
    const CONFIG_ENABLE_MENU = "oe_gheit_add_menu_button";
    const CONFIG_ENABLE_BODY_FOOTER = "oe_gheit_add_body_footer";
    const CONFIG_ENABLE_FHIR_API = "oe_gheit_enable_fhir_api";
    ...
    public function getGlobalSettingSectionConfiguration()
    {
        $settings = [
            ...
            ,self::CONFIG_OVERRIDE_TEMPLATES => [
                'title' => 'Gheit Module enable overriding twig files'
                ,'description' => 'Shows example of overriding a twig file'
                ,'type' => GlobalSetting::DATA_TYPE_BOOL
                ,'default' => ''
            ]
            ,self::CONFIG_ENABLE_MENU => [
                'title' => 'Gheit Module add module menu item'
            ...
            ,self::CONFIG_ENABLE_BODY_FOOTER => [
                'title' => 'Gheit Module Enable Body Footer example.'
                ,'description' => 'Shows example of adding a menu item to the system (requires logging out and logging in again)'
                ,'type' => GlobalSetting::DATA_TYPE_BOOL
                ,'default' => ''
            ]
            ,self::CONFIG_ENABLE_FHIR_API => [
                'title' => 'Gheit Module Enable FHIR API Extension example.'
